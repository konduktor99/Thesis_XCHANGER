...
<img src= "../assets/images/logo_xchanger.png" alt=" EKOŁO Logo" width="170" height="50">
      ...
      <div class="dropdown">
        ...
        <div  class="dropdown-content">
          <router-link :to="{ path: `/my-profile`, query: {user:`konduktor`}}" v-if="loggedIn">Mój profil
          ...
          <router-link to="/signin" v-else>Zarejestruj się
           ...
           <a href="#" v-if="loggedIn">Wyloguj się
          ...
          <router-link to="/items/login" v-else>Zaloguj się
